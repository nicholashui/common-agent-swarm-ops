---
name: video-interviewsynthesis
description: Role harness for video.interviewsynthesis — Synthesizes practitioner interviews into data
version: 1.0.0
agent_id: video.interviewsynthesis
---

# Skill — `video.interviewsynthesis`

## When to use
Load this skill when the host routes a task to `video.interviewsynthesis` or when composing a swarm step that requires this craft role.

## Instructions
1. Load prompt `video.prompt.interviewsynthesis.v1` from `../prompts/`.
2. Load rubric `video.rubric.interviewsynthesis.v1` from `../rubrics/`.
...
- **Entry:** pack agent `video.interviewsynthesis` via host agent runner
...
## Tests
- Offline golden: `business/video/evals/agents/video.interviewsynthesis/golden.json`
- Must not require live network for L1 pass when tools are mocked.

<!-- RETHINK_100:start -->
## RETHINK_100 harness notes

Source: `business/video/corpus/study/ui/RETHINK_100_IMPROVEMENTS.md` (applied ids: 15, 21, 26, 30, 31, 37, 38, 59, 63, 73, 87, 88, 93, 94).
...
- Agent: `video.interviewsynthesis`
<!-- RETHINK_100:end -->
