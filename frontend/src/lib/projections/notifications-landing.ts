  ...
  items: [
    {
      ...
      kind: "gate",
      priority: "high",
      title: "Approval gate ready · video.editor v3.0 rollout",
    ...
    },
    {
      ...
      kind: "anomaly",
      priority: "high",
      title: "Anomaly · error spike after video.editor v2.1",
    ...
    },
    {
      ...
      kind: "proposal",
      priority: "normal",
      title: "New improvement proposal · video.analyst v2.5",
    ...
    },
    {
      ...
      kind: "common",
      priority: "low",
      title: "Common improved · video.judge v3.0 merged",
    ...
    },
    {
      ...
      kind: "critique",
      priority: "normal",
      title: "Directed critique resolved · video.screenwriter",
    ...
    },
    {
      ...
      kind: "budget",
      priority: "normal",
      title: "Budget threshold · Wuxia Short",
