...
export const LOCAL_REGISTRY_LANDING: RegistryLandingView = {
  labels: {
    ...
    "usage": "Usage",
    "actions": "Actions",
    "my_contributions_forks_require_an_authorized_pro": "My Contributions & Forks",
    "my_contributions_local_note": "No host contribution projection is loaded yet. Showing local catalog only — forks and proposals appear here when the Host returns your contribution list.",
    "pending_proposals_shown_from_local_fixture": "Pending proposals",
    "pending_proposals_empty_note": "No pending proposals in this workspace projection. The pack catalog is read-only; Host proposal queue appears here when linked.",
    "pending_proposals_count_note": "{count} proposal(s) in the current projection.",
  ...
  patterns: [
    {
      ...
      icon: "⊞",
      whenToUse: "Parallel branches · shard work · scale out.",
    ...
    },
    {
      ...
      icon: "↺",
      whenToUse: "Refine until quality passes.",
