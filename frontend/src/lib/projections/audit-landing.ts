  ...
  rows: [
    {
      ...
      actionType: "rollback",
      target: "CommonReportAgent v2.1 → v2.0",
    ...
    },
    {
      ...
      actionType: "approval",
      target: "ReportAgent v3.0 rollout gate",
    ...
    },
    {
      ...
      actionType: "rollout",
      target: "CommonReportAgent v3.0 · 5 swarms",
