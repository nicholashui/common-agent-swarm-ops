...
export const COMMON_AGENTS: readonly CommonAgent[] = [
  { id: "trend-sentinel", name: "Trend Sentinel", version: "2.4", description: "Triages trend signals with source-backed confidence.", successRate: "94.8%", usage: "1.2k swarms", tags: ["Video", "Verified"] },
...
export const PATTERNS = [
  ...
  { id: "map-reduce", name: "Parallel shards with consensus", version: "1.2", description: "Shard large inputs, combine candidate outputs, and vote on a result.", metrics: "89% success · scalable" },
] as const;

export const RECENT_RUNS = [
  { name: "Daily video brief", pattern: "Parallel + verification", status: "success" as const, duration: "4m 12s", cost: "$0.38", commons: "6 linked" },
