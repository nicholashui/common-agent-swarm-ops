...
export function AuditHome({
  view = LOCAL_AUDIT_LANDING,
}: Readonly<{ view?: AuditLandingView }>): JSX.Element {
  ...
  return (
    <section aria-label="Governance and audit trail" className="audit-home">
      <header className="audit-home__header">
        ...
        <div className="audit-home__header-actions">
          <label className="audit-home__search">
            <span className="visually-hidden">Search audit log</span>
            <input
      ...
      <div className="audit-home__body">
        <aside aria-label="Audit filters" className="audit-home__filters">
          <h2>Filters</h2>
          ...
          <div className="audit-home__action-types" role="group" aria-label="Action type">
            <p>Action type</p>
        ...
        <div className="audit-home__main">
          <div className="audit-home__table-wrap" role="region" aria-label="Audit table">
            <table className="audit-home__table">
              <thead>
                <tr>
                  ...
                  <th scope="col">Before / After summary</th>
...
function EventDetail({
  ...
  return (
    <aside aria-label="Event detail" className="audit-home__detail">
      ...
      <dl className="audit-home__detail-grid">
        ...
        {row.commonVersion ? (
          <div>
            <dt>Common version</dt>
            <dd>{row.commonVersion}</dd>
          </div>
        ) : null}
      </dl>

      <h3>Context (redacted)</h3>
      ...
      <pre className="audit-home__diff" aria-label="Redacted diff">
