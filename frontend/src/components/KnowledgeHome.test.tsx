...
test("knowledge home matches ui_10 md/svg structure", () => {
  ...
  assert.match(markup, /Show sample knowledge|Hide sample knowledge/);
  assert.match(markup, /Common \+ business-scoped RAG sources|Sample knowledge collections/);
  ...
  assert.match(markup, /Video Corpus \(Common\)/);
  ...
  assert.match(markup, /Git · Video Corpus|Git/);
  assert.match(markup, /untrusted refs/);
  assert.match(markup, /Detail/);
  assert.match(markup, />Sources</);
  assert.match(markup, /Search Test/);
  assert.match(markup, /wuxia_hooks_2026\.md/);
  assert.match(markup, /trend_dataset\.csv/);
  assert.match(markup, /production_wiki/);
