...
test("costs home matches ui_19 md/svg structure", () => {
  ...
  assert.match(markup, /Tutor Fleet/);
  assert.match(markup, /Archive Batch/);
  assert.match(markup, /Others \(4\)/);
  assert.match(markup, /Token Usage by Agent/);
  assert.match(markup, /video.webresearch v2\.1/);
  assert.match(markup, /video.trendintelligence v1\.9/);
  assert.match(markup, /video.judge v3\.0/);
  assert.match(markup, /video.copywriter/);
  assert.match(markup, /video.editor v2\.2/);
