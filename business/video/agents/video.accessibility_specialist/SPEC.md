...
## Identity
- Common Agent ID: `video.accessibility_specialist`
- Status: `registered`
- Maturity: `L0`
- Pack version: `0.2.0`

## Responsibility
Owns the video-domain accessibility specialist outcome by producing a reviewable video artifact, applying the approved pack rubric, recording acceptance criteria, and escalating rights, safety, or quality failures before downstream handoff.
...
- Local rubric reference: `video.rubric.accessibility_specialist.v1`.
- Prompt reference: `video.prompt.accessibility_specialist.v1`; references are inert local contract identifiers.
...
- [Reviewed local source document](../../agents/video.accessibility_specialist/agent_spec.json)
