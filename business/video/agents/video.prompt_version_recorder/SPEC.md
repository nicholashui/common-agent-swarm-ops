...
## Identity
- Common Agent ID: `video.prompt_version_recorder`
- Status: `registered`
- Maturity: `L0`
- Pack version: `0.2.0`

## Responsibility
Owns the video-domain prompt version recorder outcome by producing a reviewable video artifact, applying the approved pack rubric, recording acceptance criteria, and escalating rights, safety, or quality failures before downstream handoff.
...
- Local rubric reference: `video.rubric.prompt_version_recorder.v1`.
- Prompt reference: `video.prompt.prompt_version_recorder.v1`; references are inert local contract identifiers.
...
- [Reviewed local source document](../../agents/video.prompt_version_recorder/agent_spec.json)
