---
name: video-childrensauthor
description: Role harness for video.childrensauthor — Age-appropriate story + safety
version: 1.0.0
agent_id: video.childrensauthor
---

# Skill — `video.childrensauthor`

## When to use
Load this skill when the host routes a task to `video.childrensauthor` or when composing a swarm step that requires this craft role.

## Instructions
1. Load prompt `video.prompt.childrensauthor.v1` from `../prompts/`.
2. Load rubric `video.rubric.childrensauthor.v1` from `../rubrics/`.
...
- **Entry:** pack agent `video.childrensauthor` via host agent runner
...
## Tests
- Offline golden: `business/video/evals/agents/video.childrensauthor/golden.json`
