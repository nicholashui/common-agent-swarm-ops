---
name: video-casting
description: Role harness for video.casting — Voice + likeness selection; audition simulation
version: 1.0.0
...
## When to use
Load this skill when the host routes a task to `video.casting` or when composing a swarm step that requires this craft role.

## Instructions
1. Load prompt `video.prompt.casting.v1` from `../prompts/`.
2. Load rubric `video.rubric.casting.v1` from `../rubrics/`.
...
- **Entry:** pack agent `video.casting` via host agent runner
...
## Tests
- Offline golden: `business/video/evals/agents/video.casting/golden.json`
- Must not require live network for L1 pass when tools are mocked.

<!-- RETHINK_100:start -->
## RETHINK_100 harness notes

Source: `business/video/corpus/study/ui/RETHINK_100_IMPROVEMENTS.md` (applied ids: 2, 15, 16, 21, 26, 30, 31, 32, 33, 34, 37, 38, 42, 44, 48, 59, 63, 84, 87, 88…).
