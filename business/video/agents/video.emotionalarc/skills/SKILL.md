---
name: video-emotionalarc
description: Role harness for video.emotionalarc — Maps valence/arousal curve; suggests beats
version: 1.0.0
agent_id: video.emotionalarc
---

# Skill — `video.emotionalarc`

## When to use
Load this skill when the host routes a task to `video.emotionalarc` or when composing a swarm step that requires this craft role.

## Instructions
1. Load prompt `video.prompt.emotionalarc.v1` from `../prompts/`.
2. Load rubric `video.rubric.emotionalarc.v1` from `../rubrics/`.
...
- **Entry:** pack agent `video.emotionalarc` via host agent runner
...
## Tests
- Offline golden: `business/video/evals/agents/video.emotionalarc/golden.json`
- Must not require live network for L1 pass when tools are mocked.

<!-- RETHINK_100:start -->
## RETHINK_100 harness notes

Source: `business/video/corpus/study/ui/RETHINK_100_IMPROVEMENTS.md` (applied ids: 15, 21, 26, 30, 31, 37, 38, 49, 59, 63, 87, 88, 92, 93, 94).
