...
## Identity
- Common Agent ID: `video.video_generation_operator`
- Status: `registered`
- Maturity: `L0`
- Pack version: `0.2.0`

## Responsibility
Owns the video-domain video generation operator outcome by producing a reviewable video artifact, applying the approved pack rubric, recording acceptance criteria, and escalating rights, safety, or quality failures before downstream handoff.
...
- Local rubric reference: `video.rubric.video_generation_operator.v1`.
- Prompt reference: `video.prompt.video_generation_operator.v1`; references are inert local contract identifiers.
...
- [Reviewed local source document](../../agents/video.video_generation_operator/agent_spec.json)
