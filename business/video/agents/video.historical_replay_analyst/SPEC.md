...
## Identity
- Common Agent ID: `video.historical_replay_analyst`
- Status: `registered`
- Maturity: `L0`
- Pack version: `0.2.0`

## Responsibility
Owns the video-domain historical replay analyst outcome by producing a reviewable video artifact, applying the approved pack rubric, recording acceptance criteria, and escalating rights, safety, or quality failures before downstream handoff.



### Domain distillation (embedded)

### Distilled responsibility (video.archiveresearch)

Historical / academic / archival deep search

### Distilled quality (video.archiveresearch)
...
- Local rubric reference: `video.rubric.historical_replay_analyst.v1`.
- Prompt reference: `video.prompt.historical_replay_analyst.v1`; references are inert local contract identifiers.
...
- [Reviewed local source document](../../agents/video.historical_replay_analyst/agent_spec.json)
