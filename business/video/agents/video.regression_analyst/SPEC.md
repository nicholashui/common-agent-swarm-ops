...
## Identity
- Common Agent ID: `video.regression_analyst`
- Status: `registered`
- Maturity: `L0`
- Pack version: `0.2.0`

## Responsibility
Owns the video-domain regression analyst outcome by producing a reviewable video artifact, applying the approved pack rubric, recording acceptance criteria, and escalating rights, safety, or quality failures before downstream handoff.
...
- Local rubric reference: `video.rubric.regression_analyst.v1`.
- Prompt reference: `video.prompt.regression_analyst.v1`; references are inert local contract identifiers.
...
- [Reviewed local source document](../../agents/video.regression_analyst/agent_spec.json)
