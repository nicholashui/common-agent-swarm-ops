...
## Identity
- Common Agent ID: `video.environment_designer`
- Status: `registered`
- Maturity: `L0`
- Pack version: `0.2.0`

## Responsibility
Owns the video-domain environment designer outcome by producing a reviewable video artifact, applying the approved pack rubric, recording acceptance criteria, and escalating rights, safety, or quality failures before downstream handoff.



### Domain distillation (embedded)

### Distilled responsibility (video.worldbuilding)

Lore, rules, geography, factions, magic/tech systems

### Distilled quality (video.worldbuilding)
...
- Local rubric reference: `video.rubric.environment_designer.v1`.
- Prompt reference: `video.prompt.environment_designer.v1`; references are inert local contract identifiers.
...
- [Reviewed local source document](../../agents/video.environment_designer/agent_spec.json)
