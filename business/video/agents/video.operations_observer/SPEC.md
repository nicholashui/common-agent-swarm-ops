...
## Identity
- Common Agent ID: `video.operations_observer`
- Status: `registered`
- Maturity: `L0`
- Pack version: `0.2.0`

## Responsibility
Owns the video-domain operations observer outcome by producing a reviewable video artifact, applying the approved pack rubric, recording acceptance criteria, and escalating rights, safety, or quality failures before downstream handoff.
...
- Local rubric reference: `video.rubric.operations_observer.v1`.
- Prompt reference: `video.prompt.operations_observer.v1`; references are inert local contract identifiers.
...
- [Reviewed local source document](../../agents/video.operations_observer/agent_spec.json)
