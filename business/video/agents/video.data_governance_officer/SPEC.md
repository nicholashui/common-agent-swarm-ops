...
## Identity
- Common Agent ID: `video.data_governance_officer`
- Status: `registered`
- Maturity: `L0`
- Pack version: `0.2.0`

## Responsibility
Owns the video-domain data governance officer outcome by producing a reviewable video artifact, applying the approved pack rubric, recording acceptance criteria, and escalating rights, safety, or quality failures before downstream handoff.
...
- Local rubric reference: `video.rubric.data_governance_officer.v1`.
- Prompt reference: `video.prompt.data_governance_officer.v1`; references are inert local contract identifiers.
...
- [Reviewed local source document](../../agents/video.data_governance_officer/agent_spec.json)
