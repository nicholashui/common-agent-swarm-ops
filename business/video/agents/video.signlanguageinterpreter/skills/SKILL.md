---
name: video-signlanguageinterpreter
description: Role harness for video.signlanguageinterpreter — Accurate ASL/BSL interpretation
version: 1.0.0
agent_id: video.signlanguageinterpreter
---

# Skill — `video.signlanguageinterpreter`

## When to use
Load this skill when the host routes a task to `video.signlanguageinterpreter` or when composing a swarm step that requires this craft role.

## Instructions
1. Load prompt `video.prompt.signlanguageinterpreter.v1` from `../prompts/`.
2. Load rubric `video.rubric.signlanguageinterpreter.v1` from `../rubrics/`.
...
- **Entry:** pack agent `video.signlanguageinterpreter` via host agent runner
...
## Tests
- Offline golden: `business/video/evals/agents/video.signlanguageinterpreter/golden.json`
...
- Agent: `video.signlanguageinterpreter`
<!-- RETHINK_100:end -->
