...
`business/video/evals/agents/video.critic/golden.json`
...
```bash
python scripts/business/record_human_baseline.py --agent video.critic --score <N> --rater <your_id> --notes "..."
```
...
```bash
python scripts/business/record_human_baseline.py --agent video.critic --score 0 --rater <your_id> --evaluate
```

(Use session mode instead:)

```bash
python scripts/business/record_human_baseline.py --session --agent video.critic --rater <your_id> --evaluate
```
