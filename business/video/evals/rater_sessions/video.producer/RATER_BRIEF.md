...
`business/video/evals/agents/video.producer/golden.json`
...
```bash
python scripts/business/record_human_baseline.py --agent video.producer --score <N> --rater <your_id> --notes "..."
```
...
```bash
python scripts/business/record_human_baseline.py --agent video.producer --score 0 --rater <your_id> --evaluate
```

(Use session mode instead:)

```bash
python scripts/business/record_human_baseline.py --session --agent video.producer --rater <your_id> --evaluate
```
