...
`business/video/evals/agents/video.judge/golden.json`
...
```bash
python scripts/business/record_human_baseline.py --agent video.judge --score <N> --rater <your_id> --notes "..."
```
...
```bash
python scripts/business/record_human_baseline.py --agent video.judge --score 0 --rater <your_id> --evaluate
```

(Use session mode instead:)

```bash
python scripts/business/record_human_baseline.py --session --agent video.judge --rater <your_id> --evaluate
```
