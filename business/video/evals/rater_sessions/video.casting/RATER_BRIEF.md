...
`business/video/evals/agents/video.casting/golden.json`
...
```bash
python scripts/business/record_human_baseline.py --agent video.casting --score <N> --rater <your_id> --notes "..."
```
...
```bash
python scripts/business/record_human_baseline.py --agent video.casting --score 0 --rater <your_id> --evaluate
```

(Use session mode instead:)

```bash
python scripts/business/record_human_baseline.py --session --agent video.casting --rater <your_id> --evaluate
```
